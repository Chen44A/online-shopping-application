...
const products = [
  {
    ...
    image: 'http://localhost:5031/images/Rituals-Classic-Advent-Calendar.webp',
  },
  {
    id: '2',
    ...
    image: 'http://localhost:5031/images/Jo-Malone-London-Advent-Calendar.webp',
  },
  {
    id: '3',
    brand: 'La Mer',
    ...
    image:
      'http://localhost:5031/images/La-Mer-The-Wonder-Express-Advent-Calendar.webp',
  },
];
...
export const handlers = [
  ...
  http.get('http://localhost:5031/products', () => {
    return HttpResponse.json(products);
  }),

  // New handler for getting product by ID
  http.get('http://localhost:5031/products/:id', (req) => {
    const { id } = req.params;
  ...
  http.get('http://localhost:5031/cart', () => {
